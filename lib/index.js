...
const BinWrapper = require("./binwrapper.js");
const pkgjson = require("../package.json");


const url = `https://github.com/gohugoio/hugo/releases/download/v${pkgjson.version}/hugo_${pkgjson.version}`;

module.exports = new BinWrapper()
	.src(`${url}_macOS-32bit.tar.gz`, "darwin", "x32")
